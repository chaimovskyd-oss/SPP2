      ...
      >
        ...
        <label style={{ display: "flex", flexDirection: "column", gap: 4 }}>
          <span style={{ fontSize: 12, color: "var(--text-secondary)" }}>
            עוצמת התאמה בטוחה – {Math.round(options.strength * 100)}%
          </span>
          <input
        ...
        {/* Neural toggle */}
        <label
          style={{ display: "flex", alignItems: "center", gap: 8, cursor: "not-allowed", fontSize: 12, opacity: 0.45 }}
          title="מצב נוירלי אינו זמין — אין מודל מותקן ב-SPP2_MODELS_DIR/harmonize/model.onnx"
        >
          <input
            type="checkbox"
            checked={false}
