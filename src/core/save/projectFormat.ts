...
export function createProjectEnvelope(input: Omit<ProjectEnvelope, "format" | "version" | "projectVersion" | "appVersion" | "schemaVersion"> & Partial<Pick<ProjectEnvelope, "projectVersion" | "appVersion" | "schemaVersion">>): ProjectEnvelope {
  return {
    format: "SPP_PROJECT",
